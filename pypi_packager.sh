...
#description    :This script will build a source distribution and wheel. It can
#                convert a README.md to README.rst for nice rendering on PyPI.
...
Script to build source distribution and wheel for a python package. Also can
convert a README.md to README.rst thanks to pandoc for nice rendering on PyPI.

Usage: $PROGRAM_NAME [-h,--help,-v,--version] [-t,--test|-s,--submit [--no-tag,--rdme-md-rst]]
...
Options:
    ...
    --rdme-md-rst   convert README from Markdown to RST
